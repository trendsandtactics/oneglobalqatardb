...
import { Clock, Plane, Package, Timer, FileCheck, LucideIcon } from 'lucide-react';
import { motion } from 'framer-motion';
import { useQuery } from '@tanstack/react-query';
import { getSiteContent, defaultContent } from '@/pages/api';

const FEATURE_ICONS: LucideIcon[] = [Clock, Package, Plane, Timer, FileCheck];
...
const AirFreight = () => {
  ...
  const page = siteContent?.airFreight || defaultContent.airFreight;
  const features = page.features?.length ? page.features : defaultContent.airFreight.features;
