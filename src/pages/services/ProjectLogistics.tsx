...
import { Package, Settings, ClipboardCheck, Shield, LucideIcon } from 'lucide-react';
import { motion } from 'framer-motion';
import { useQuery } from '@tanstack/react-query';
import { getSiteContent, defaultContent } from '@/pages/api';

const FEATURE_ICONS: LucideIcon[] = [Package, Settings, ClipboardCheck, Shield];
...
const ProjectLogistics = () => {
  ...
  const page = siteContent?.projectLogistics || defaultContent.projectLogistics;
  const features = page.features?.length ? page.features : defaultContent.projectLogistics.features;
